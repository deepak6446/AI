export class PlayerControls {
  ...
  updateControls(state) {
    ...
    this.elements.playPauseBtn.disabled =
      !state.duration && !state.isGenerating;
    this.elements.seekSlider.disabled = !state.duration;
    this.elements.cancelBtn.style.display = state.isGenerating
      ? "block"
      : "none";
