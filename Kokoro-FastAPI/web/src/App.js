...
export class App {
  ...
  setupAudioEvents() {
    ...
    this.audioService.addEventListener("bufferError", () => {
      this.showStatus(
        "Processing... (Download will be available when complete)",
        "info"
      );
    });
  ...
  setGenerating(isGenerating) {
    ...
    this.elements.generateBtnLoader.style.display = isGenerating
      ? "block"
      : "none";
    this.elements.generateBtnText.style.visibility = isGenerating
      ? "hidden"
      : "visible";
